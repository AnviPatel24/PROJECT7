              ...
              <div className='card'>
                <div className='card-body'>
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-3'>
                      <label htmlFor='textRoomNO' className='form-label'>
                        Room Number
                      </label>
                      <input
                        type='text'
                      ...
                      />
                      <div id='roomno' className='form-text'>
                        ROom Number Format A-16.
                      </div>
